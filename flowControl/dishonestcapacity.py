print('Enter TB or GB for advertising unit:')
unit = input('>')

# Calculate the amount that the advertised capacity lies:
if unit == 'TB' or unit == 'tb':
    descrepancy = 1000000000000 / 1099511627776
...
real_capacity = str(round(advertised_capacity * descrepancy, 2))

print('The actual capacity ' + real_capacity + ' ' + unit)
